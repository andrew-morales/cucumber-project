...
//	 private WebElement drpdwn_CountyDropDownArrow;
	 ...
	 public void select_Country(String countryName, WebDriverWait wait) {
		 //create a select with the web element to enable use of select functions
		 Select countrySel = new Select(drpdwn_CountryDropDownArrow);
		 wait.withMessage("Waiting for the country dropdwon to be clickable");
		 wait.until(ExpectedConditions.elementToBeClickable(drpdwn_CountryDropDownArrow));
...
//		 }
	 ...
	 public void select_County(String countyName) {
		 Select countySel = new Select(drpdwn_CountyDropDownArrow);
		 countySel.selectByVisibleText(countyName);
...
//		 }
	 ...
	 public void fill_PersonalDetails(WebDriverWait wait, Customer customer) {
		 ...
		 select_Country(customer.address.country, wait);
